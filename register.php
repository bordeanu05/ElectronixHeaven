...
// Insert user data into the database
    ...
    if ($result) {
        ...
        try {
            ...
            $mail->Body = "Click the following link to verify your email: <a href='http://localhost/ElectronixHeaven/verified.php?token=$token'>Verify Email</a>";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/product-page.css?<?php echo time(); ?>" />
