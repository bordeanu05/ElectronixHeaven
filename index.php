  ...
  <body>
    ...
    <div id="showcase">
      <div class="container showcase-content">
        <div class="showcase-text"><h2>WELCOME TO ELECTRONIX HEAVEN!</h2></div>
        <div class="showcase-button"><a href="shop.php">SHOP NOW</a></div>
      </div>
    </div>

    <div id="preview">
      <div class="preview-content container">
        <div class="preview-product"><img src="imagini/casti_hyperx.avif" /></div>
        <div class="preview-product"><img src="imagini/telefon_xiaomi.avif" /></div>
        <div class="preview-product"><img src="imagini/trotineta.avif" /></div>
      </div>
    </div>
